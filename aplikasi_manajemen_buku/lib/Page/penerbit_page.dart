...
class _PenerbitPageState extends State<PenerbitPage> {
  ...
  Future<void> fetchBooks() async {
    ...
    const url = 'http://103.196.155.42/api/buku/penerbit';
    try {
  ...
  Future<void> updateBook(
    ...
    final url = 'http://103.196.155.42/api/buku/penerbit/$id/update';
    try {
  ...
  Future<void> deleteBook(int id) async {
    final url = 'http://103.196.155.42/api/buku/penerbit/$id/delete';
    try {
